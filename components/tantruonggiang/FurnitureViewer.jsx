        ...
        <div className="w-full md:w-1/3 grid grid-cols-2 gap-4">
          {tabs.map((tab) => (
            <button
              ...
              className={`${
                selectedTab === tab.name ? "bg-green-700" : "bg-gray-800"
              } text-white py-4 rounded-lg flex flex-col items-center justify-center gap-2 hover:bg-green-600 transition-colors focus:outline-none focus:ring-2 focus:ring-green-500`}
